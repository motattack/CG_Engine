...
int main() {
    ...
    while (window.isOpen()) {
        ...
        // Point Lights
        for (int i = 0; i < 4; i++) {
            myShader.setVec3("pointLights[" + std::to_string(i) + "].position",
                             pointLightPositions[i] * xValue);
            myShader.setVec3("pointLights[" + std::to_string(i) + "].ambient",
                             Vec3(point_ambient[0], point_ambient[1], point_ambient[2]));
            myShader.setVec3("pointLights[" + std::to_string(i) + "].diffuse",
                             Vec3(point_diffuse[0], point_diffuse[1], point_diffuse[2]));
            myShader.setVec3("pointLights[" + std::to_string(i) + "].specular",
